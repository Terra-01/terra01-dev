      ...
      <main className="mx-auto max-w-screen-xl px-6 pt-8 pb-12 md:px-12 md:pt-16 md:pb-20">
        <header className="flex flex-col items-center gap-8 lg:flex-row lg:justify-between lg:items-start mb-8">
            <div className="flex items-center gap-4">
                <Image src="/profile.png" alt="Profile Picture" width={80} height={80} className="w-20 h-20 rounded-full object-cover" priority/>
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-[var(--color-text-primary)]">Shivam Singh</h1>
                    <h2 className="mt-1 text-md font-medium tracking-tight text-[var(--color-text-secondary)]">Software Engineer</h2>
                    <p className="mt-2 max-w-xs text-sm leading-normal text-[var(--color-text-muted)]">Not your average Pokèmon Master.</p>
                </div>
            </div>
